...
#%%
name, sample_log = "results_noidx/func0", False
name, sample_log = "results_noidx/func1", False
name, sample_log = "results_noidx/func2", False
name, sample_log = "results_noidx/func3", False
